package com.wsdm.common.core.domain;
...
public class AjaxResult extends HashMap<String, Object> {
     ...
     * @return
     */
    public static AjaxResult error(ResultEnums resultEnums) {
        return AjaxResult.error(resultEnums.getCode(), resultEnums.getMsg());
    }

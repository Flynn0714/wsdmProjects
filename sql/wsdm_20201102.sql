...
values (100, 0, '0', '维思夺目（南京）智能科技有限公司', 0, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '南京总公司', 1, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (102, 100, '0,100', '泰州分公司', 2, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, '维思夺目', '15251491501', '', '0', '0', 'admin', sysdate(), '', null);
...
insert into sys_menu
values ('108', '日志管理', '1', '9', 'log', 'system/log/index', 1, 0, 'M', '0', '0', '', 'log', 'admin', sysdate(), '',
        null, '日志管理菜单');
insert into sys_menu
...
insert into sys_menu
values ('113', '表单构建', '3', '1', 'build', 'tool/build/index', 1, 0, 'C', '0', '0', 'tool:build:list', 'build', 'admin',
        sysdate(), '', null, '表单构建菜单');
insert into sys_menu
values ('114', '代码生成', '3', '2', 'gen', 'tool/gen/index', 1, 0, 'C', '0', '0', 'tool:gen:list', 'code', 'admin',
        sysdate(), '', null, '代码生成菜单');
insert into sys_menu
...
-- 代码生成按钮
insert into sys_menu
values ('1055', '生成查询', '114', '1', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:query', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1056', '生成修改', '114', '2', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:edit', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1057', '生成删除', '114', '3', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:remove', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1058', '导入代码', '114', '2', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:import', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1059', '预览代码', '114', '4', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:preview', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1060', '生成代码', '114', '5', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:code', '#', 'admin', sysdate(), '', null,
        '');
